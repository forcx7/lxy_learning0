...
from GRL_Net.Pytorch_GRL_Dueling import torch_GRL_Dueling  # 导入编写的pytorch下的网络
...
def Create_DQN(num_HVs, num_AVs, param):
    ...
    gamma = 0.99
    # 定义智能体策略参数
    explorer_0 = explorer.LinearDecayEpsilonGreedy(start_epsilon=0.9, end_epsilon=0.01, decay_step=1200000)
